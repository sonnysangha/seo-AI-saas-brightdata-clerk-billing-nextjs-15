        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-32 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-6 max-w-2xl mx-auto text-lg sm:text-xl text-muted-foreground leading-relaxed">
              Harness the power of Bright Data&apos;s SERP Perplexity Scraper to create comprehensive SEO reports instantly. 
              <span className="text-foreground font-medium"> Fast, simple, and incredibly insightful.</span>
            </p>
            
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Unauthenticated>
                <SignInButton mode="modal">
                  <Button size="lg" className="text-base px-8 py-6 shadow-lg hover:shadow-xl transition-all duration-300 group">
            ...
            <Card className="relative overflow-hidden border-2 hover:border-primary/50 transition-all duration-300 hover:shadow-xl group">
              ...
              <CardHeader className="relative">
                ...
                <CardDescription className="text-base">
                  Generate comprehensive SEO reports powered by Bright Data&apos;s advanced SERP Perplexity Scraper technology.
                </CardDescription>
              </CardHeader>
              <CardContent>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              Choose the plan that fits your SEO needs. Upgrade or downgrade anytime.
            </p>
          </div>
            ...
            <Card className="border-primary hover:shadow-xl transition-all duration-300 relative">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-2">
                    <CheckCircle className="w-4 h-4 text-green-600" />
                    <span className="text-sm font-medium">AI Chat with reports</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle className="w-4 h-4 text-green-600" />
      ...
      <section className="py-20 bg-gradient-to-r from-primary/10 via-background to-accent/10">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Join thousands of marketers who trust our platform to deliver actionable SEO insights. 
